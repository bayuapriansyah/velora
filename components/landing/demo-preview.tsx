...
export function DemoPreview() {
  return (
    <section className="px-6 py-24 md:py-32 bg-black/20 backdrop-blur-md">
      <div className="mx-auto max-w-4xl rounded-[40px] bg-surface p-12 text-center border border-hairline md:p-20 relative overflow-hidden shadow-[0_0_60px_-15px_rgba(254,77,71,0.30)]">
